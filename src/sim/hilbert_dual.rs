...
#[allow(dead_code)]
pub struct HilbertDualNeighborSearch {
    bits: u32,
...
#[allow(dead_code)]
impl HilbertDualNeighborSearch {
    #[allow(dead_code)]
...
impl NeighborSearch for HilbertDualNeighborSearch {
    ...
    fn neighbors(&self, boids: &[Boid], behavior: &BoidBehavior, index: usize) -> Vec<usize> {
        ...
        Self::collect_from(&self.items_yx, key_yx, boids, behavior, index, &mut acc, limit);
